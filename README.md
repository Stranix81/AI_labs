...
#### ♦ Дополнительное задание №2 (Базы данных с шаблонами)
 Цели:
  - Реализовать генерацию допустимых эвристик для A* поиска применительно к своей задаче.

#### ♦ Дополнительное задание №3 (Поиск SMA*)
 Цели:
  - Реализовать поиск SMA* применительно к своей задаче.
...
- Алгоритм выбирается вручную:
  ...
  - SMA* (Simplified Memory Bounded A*) - поиск A* с ограничением на максимальное количество открытых узлов
